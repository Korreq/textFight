...
public class TablicaPotworow {
    private Potwory S1 = new Potwory("S1",25,25,10,10,0,false);
    private Potwory M1 = new Potwory("M1",20,20,10,10,0,false);
    private Potwory L1 = new Potwory("L1",25,25,10,10,0,false);

    private Potwory S2 = new Potwory("S2",40,40,16,10,0,false);
    private Potwory M2 = new Potwory("M2",35,35,16,10,0,false);
    private Potwory L2 = new Potwory("L2",30,30,16,10,0,false);

    private Potwory S3 = new Potwory("S3",55,55,20,10,0,false);
    private Potwory M3 = new Potwory("M3",50,50,20,10,0,false);
    private Potwory L3 = new Potwory("L3",40,40,20,10,0,false);
